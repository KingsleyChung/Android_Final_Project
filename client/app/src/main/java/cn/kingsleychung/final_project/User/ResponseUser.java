...
/**
 * Created by zhoug on 2017/12/31.
 */
...
public class ResponseUser {
        ...
        public static class User {
            ...
            public User(String userName, String nickName, String password, String phone, String email, String qq, String wechat) {
                this.userId = "";
        ...
        public ResponseUser(String userName, String nickName, String password, String phone, String email, String qq, String wechat) {
            this.success = false;
            this.message = "";
            this.user = new User(userName,nickName,password, phone, email,qq,wechat);
        }
